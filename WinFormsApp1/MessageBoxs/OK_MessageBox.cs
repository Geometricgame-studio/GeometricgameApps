...
{
    public partial class OK_MessageBox : Form_border_style
    {
        string title = "";
        string text = "";
        string icon_name = "";
        public OK_MessageBox(string msg_text, string msg_title, string icon)
        {
            InitializeComponent();
            ...
            title_text.Text = msg_title.ToString();
        }
        ...
        private void OK_MessageBox_FormClosing(object sender, FormClosingEventArgs e)
        {
